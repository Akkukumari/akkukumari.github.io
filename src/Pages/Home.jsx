...
const Home = () => {
    ...
    return (
        <Box>
                ...
                <Flex flexDirection={['column-reverse', 'column-reverse', 'row']} m="auto" justifyContent="space-around" alignItems="center" h="100%">
                    <Box data-aos="fade-down">
                        ...
                        <Box className='content'>
                            <Heading fontSize="3.3em" className='text' data-text="Akanksha Kumari"><span className='themeText'>Akanksha Kumari</span></Heading>
                        </Box>
                        <Text>I am a Full Stcak Web Developer passionate and experienced in building Web applications.</Text>
                        <HStack className='hireMe' onClick={() => { window.open("https://drive.google.com/file/d/1SNaSntIlnT9VgMg_zyhagyw7Br740a4s/view?usp=sharing", '_blank') }}>
                            <a href={Resume} download="Akanksha-Kumari-Resume">
            ...
            <Box id="about">
                ...
                <Flex flexDirection={['column-reverse', 'column-reverse', 'column-reverse', 'row']} alignItems="center" h="100%">
                    ...
                    <Flex data-aos="fade-left">
                        ...
                        <Box>
                            <Text>An ambitious and self-motivated  full stack web developer with a considerable technical skill who possesses self-discipline and ability to work. A quick learner with the ability to design website, user experience. A quick-learner who can absorb new ideas and can communicate clearly and effectively. A focused and efficient leraner with 1200+ hours of coding experience in web development.</Text>
                        </Box>
                    </Flex>
                </Flex>
            </Box>
            ...
            {/* show projects */}
            <Box id="projects">
                <Heading textAlign="center"> <span className='themeText'>Projects</span></Heading>
                <Slider {...settings}>
                    {
                        projects.map((project, i) => <ProjectCard key={PromiseRejectionEvent.id} {...project} />)
                    }
                </Slider>
            </Box>
            ...
            <Box id="githubStats">
                ...
                <Center className='github-stats'>
                    <Image src="https://github-readme-stats.vercel.app/api/top-langs/?username=Akkukumari&layout=compact&hide_border=true&theme=radical" alt="Most used languages" />
                    <Image src="https://github-profile-summary-cards.vercel.app/api/cards/profile-details?username=Akkukumari&theme=radical" alt="Github Stats" />
                </Center>

                <Center className='github-stats'>
                    <Image src="https://github-readme-stats.vercel.app/api?username=Akkukumari&show_icons=true&locale=en&layout=compact&hide_border=true&theme=radical" alt="Github stats" />
                    <Image src="https://github-readme-streak-stats.herokuapp.com/?user=Akkukumari&layout=compact&hide_border=true&theme=radical" alt="Current Streaks" />
                </Center>

                <Center>
                    <GitHubCalendar username="Akkukumari" color="#4a8af4" children={<ReactTooltip html />} />
                </Center>
            </Box>
                    ...
                    <Box className='form-section'>
                        ...
                        <Flex className='contact-info'>
                            <HStack>
                                ...
                                <Text>akanksha28sbg@gmail.com</Text>
                            </HStack>
                            <HStack>
                                <FaPhoneAlt color="#00a14f" />
                                <Text>+91 6203190814</Text>
                            </HStack>
                        </Flex>
                        <Flex gap={["10px", "20px", "20px", "40px"]}>
                            ...
                            <Link href='https://www.linkedin.com/in/akanksha-kumari-274698265/' target="_blank">
                            ...
                            <Link href="https://github.com/Akkukumari" target="_blank">
                                <Tooltip label=' u8250'>
                                    <Box className='social-icons'>
                                        <Box>
            ...
            {/* footer */}
            <Flex id='footer'>
                <Text className='end'>© Portfolio by Akanksha Kumari| All rights reserved.</Text>
            </Flex>
        </Box >
    )
}
